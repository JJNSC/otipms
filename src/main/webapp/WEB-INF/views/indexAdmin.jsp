        ...
        <!-- <script>
            ...
            <div style="width:100%;padding-right:15px;padding-left:15px;margin-left:auto;margin-right:auto;margin-top:1rem;height:810px;">
            	<div class="row">
                   ...
                   <!--  <div class="col-lg-4" style="height:70%;">
					    <div class="card" >
                ...
                <div class="row" style="height:28%;position:relative; bottom:350px;">
                    <!-- /# column -->
                    <div class="col-lg-8" style=" padding-left:30px;padding-right:20px;">
