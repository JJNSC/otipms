                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                <a class="text-center"> <h4><b>OTIPMS - 관리자 계정 생성</b></h4></a>
                                <form class="mt-5 mb-2 login-input" method="post" action="${pageContext.request.contextPath}/employeeManagement/createAdmin" enctype="multipart/form-data">
                                    ...
                                    <button type="submit" class="btn login-form__btn submit w-100 mt-4 mb-0" style="background-color: #3E6494; border-color: #3E6494;">생성</button>
                                </form>
                            </div>
                        </div>
                    </div>
