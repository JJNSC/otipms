                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                        	<tr>
                                            <!-- <tr class="reviewTitle" data-toggle="collapse" data-review-id="16" id="projectNo16" href="#collapseExample16" role="button" aria-expanded="true" aria-controls="collapseExample"> -->
                                                <td>2010001</td>
                                                <td>김진성</td>
                                                <td>부장</td>
                                                <td>010-1234-1234</td>
                                            ...
                                            <tr style="background-color:#f3f3f3;" id="16bottom">
                                                ...
                                                <td class="text-center"> 
									   			...
									   			<!-- <td style="padding-top :0px; padding-bottom :0px;" colspan="9">
