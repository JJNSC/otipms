...
<head>
   ...
   <!-- Custom Stylesheet -->
    ...
    <script src="${pageContext.request.contextPath}/resources/js/team/selectClient.js"></script>
	...
	<script src="${pageContext.request.contextPath}/resources/js/team/findClient.js"></script>
</head>
