...
<body>
	<div class="d-none" id="thisTeamNo">${teamNo}</div>
    <div id="main-wrapper">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                        	<div style="background-color: #11407a;height:60px;">
                        		<h4 class="mt-3 ml-2" style="color:#fff;"><img src="${pageContext.request.contextPath}/resources/images/otipmsCube.jpg" style="height: 30px;" alt="">팀장 찾기</h4>
                        	</div>
                            <div class="card-body">
