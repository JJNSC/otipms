...
<html
  ...
  <head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/chat/fontawesome.css" />
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/chat/flag-icons.css" />

    <!-- Core CSS -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/chat/core.css"/>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/chat/theme-default.css"/>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/chat/bootstrap-maxlength.css" />

    <!-- Page CSS -->

    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/chat/app-chat.css" />
...
Dessert chocolate cake lemon drops jujubes. Biscuit cupcake ice cream bear claw brownie brownie marshmallow.</textarea
    ...
    <!-- Vendors JS -->
    <script src="${pageContext.request.contextPath}/resources/js/chat/bootstrap-maxlength.js"></script>

    <!-- Page JS -->
    <script src="${pageContext.request.contextPath}/resources/js/chat/app-chat.js"></script>
  </body>
</html>
