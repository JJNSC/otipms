...
<div id="email-list-container" class="email-list m-t-15">
	...
	<div class="message message-2">
		<div class="col-mail col-mail-1">
			...
			<span class="icon-copy ion-android-mail mail" onclick="checkread(2, event)"></span>
		</div>
		<div class="col-mail col-mail-profile">
			<div class="profile">
	...
	<div class="message message-3">
		<div class="col-mail col-mail-1">
			...
			<span class="icon-copy ion-android-drafts mail" onclick="checkread(3, event)"></span>
		</div>
		<div class="col-mail col-mail-profile">
			<div class="profile">
	...
	<div class="message message-4">
		<div class="col-mail col-mail-1">
			...
			<span class="icon-copy ion-android-drafts mail" onclick="checkread(4, event)"></span>
		</div>
		<div class="col-mail col-mail-profile">
			<div class="profile">
