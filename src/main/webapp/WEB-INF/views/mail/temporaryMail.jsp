                                        ...
                                        <div class="d-flex justify-content-between align-items-center" style="margin-bottom:5px;">
				                            <div class="d-flex align-items-center">
				                            	<div class="form-check me-2">
			                              		...
			                              		<i id="refresh-button" class="fa icon-copy ion-loop font-18 align-middle ml-3" style="cursor: pointer;" onclick="refreshTemporaryEmailList()"></i>
				                            </div>
		                          		</div>
                                    </div>
                                   	<%@ include file="/WEB-INF/views/mail/reloadTemporaryMail.jsp" %>
                                    <!-- panel -->
