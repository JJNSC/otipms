        ...
        <!-- <div class="content-body"> -->
            ...
            <div style="width:100%;padding-right:15px;padding-left:15px;margin-left:auto;margin-right:auto;margin-top:1rem;height:810px;">
            	<div class="row">
            		...
            		<!-- 일정 -->
            		<div class="col-lg-3">
            			<div class="card" style="height: 49.2rem; z-index: 0;">
                            <div class="card-body">
                                <div class="card-title">
                                            	...
                                            	<c:forEach var="schedule" items="${scheduleList}">
						                            <li>
						                            	<strong class="labelCustom">
						                            		...
						                            		<c:if test="${schedule.scheduleChecked == true}">
						                            			<span onclick="openScheduleDetail(this)" data-toggle="modal" data-target="#add-category" style="text-decoration: line-through;display:inline-block; width:30%; white-space: nowrap; overflow:hidden; text-overflow:ellipsis;" >${schedule.scheduleName}</span>
					                            			</c:if>
					                            			<c:if test="${schedule.scheduleChecked == false}">
						                            			<span onclick="openScheduleDetail(this)" data-toggle="modal" data-target="#add-category" style='display:inline-block; width:30%; white-space: nowrap; overflow:hidden; text-overflow:ellipsis;'>${schedule.scheduleName}</span>
					                            			</c:if>
					                            			<c:set var="now" value="<%= new java.util.Date() %>" />
					                            			<c:choose>
